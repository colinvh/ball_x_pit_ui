...
<main class="flex flex-col max-w-7xl mx-auto">
  ...
  <footer class="mt-4 mb-4 text-center text-xs text-gray-500 max-w-2xl px-4 mx-auto">
    ...
    <p class="mb-3 text-gray-400">
      Want to contribute or report an issue? Click the GitHub link below to access the project
      repository.
    </p>
    ...
    <div class="flex justify-center">
      <a
        ...
        aria-label="Visit GitHub repository to contribute or report issues"
      >
        <svg
          class="w-5 h-5"
          fill="currentColor"
